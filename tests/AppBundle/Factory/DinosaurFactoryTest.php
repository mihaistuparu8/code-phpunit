...
class DinosaurFactoryTest extends TestCase
{
     ...
     */
    public function testItGrowsADinasaurFromASpecification(string $spec, bool $expectedIsLarge, bool $expectedIsCarnivorous)
    {
    ...
    public function getSpecificationTests()
    {
        return [
            ...
            ['give me all the cookiess!!!', false, false],
